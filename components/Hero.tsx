          ...
          <div className="space-y-6 animate-slide-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
              <Button 
                size="default" 
                onClick={openChat}
                className="px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white shadow-xl hover:shadow-orange-500/25 hover:scale-105 transition-all duration-300 font-bold border-0"
              >
              ...
              <Button 
                ...
                className="px-6 py-3 border-2 border-white/30 text-black hover:bg-white backdrop-blur-md font-bold transition-all duration-300 hover:scale-105"
              >
        ...
        <div className="container">
          <div className="grid grid-cols-3 gap-4 max-w-2xl mx-auto">
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4 text-center hover:bg-white/20 transition-all duration-300">
              ...
              <div className="text-2xl font-black text-white mb-1">30-45</div>
